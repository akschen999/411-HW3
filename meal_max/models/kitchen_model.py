...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    """
        Creates a meal and adds it to the meal table

        Args:
            meal (str): The name of the meal to be added.
            cuisine (str): The type of cuisine of the respective meal.
            price (float): The price of the respective meal.
            difficulty (str): The difficulty of the meal (must be LOW, MED, or HIGH)

        Raises:
            ValueError: If the price is not a positive number ,
                            OR the difficulty is not LOW, MED, or HIGH,
                                OR a meal with name {meal (str)} already exists.
...
def delete_meal(meal_id: int) -> None:
    """
        ...
        Args:
            meal_id (int): The ID of the meal to remove from the meal table.

        Raises:
            ValueError: If a meal with the meal ID has already been deleted, or is invalid.
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    """
        ...
        Args:
            sort_by (str): The criteria to sort the meals by

        Returns:
        dict[str, Any]: A sorted (as according to) sort_by) list of meals with their stats.

        Raises:
            ValueError: invalid sorting parameters.
...
def get_meal_by_id(meal_id: int) -> Meal:
    ...
    Raises:
        ValueError: If the meal with meal ID has been deleted OR cannot be found
...
def update_meal_stats(meal_id: int, result: str) -> None:
    ...
    Raises:
        ValueError: If the meal has been deleted, OR the meal is not found, OR if the result is neither a win or a loss.
